        ...
        {isLoading ? (
          ...
          >
            ...
            <p className="text-text-muted">
              Try adjusting your filters or be the first to mint!
            </p>
          </motion.div>
        ) : (
          <>
              ...
              <AnimatePresence mode="popLayout">
                {cyphers.map((cypher, i) => (
                  ...
                  >
                    <CypherCard 
                      cypher={cypher} 
                      onClick={() => setSelectedCypher(cypher)}
                    />
                  </motion.div>
                ))}
              </AnimatePresence>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div 
                      className={`badge-${selectedCypher.rarityTier.toLowerCase()} inline-block`}
                    >
                      {selectedCypher.rarityTier}
                    </div>

                    <p className="text-text-secondary text-sm">
                      {selectedCypher.description}
                    </p>
